...
#line 13 "metachop.met"
        PPTREE _ptTree0=0;
#line 13 "metachop.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(prog)(error_free), 169, metachop))== (PPTREE) -1 ) {
#line 13 "metachop.met"
...
#line 30 "metachop.met"
                PPTREE _ptTree0=0;
#line 30 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(take_follow)(error_free), 170, metachop))== (PPTREE) -1 ) {
#line 30 "metachop.met"
...
#line 31 "metachop.met"
                PPTREE _ptTree0=0;
#line 31 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(take_follow_list)(error_free), 171, metachop))== (PPTREE) -1 ) {
#line 31 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 31 "metachop.met"
...
#line 83 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(expression)(error_free), 65, metachop))== (PPTREE) -1 ) {
#line 83 "metachop.met"
...
#line 85 "metachop.met"
                PPTREE _ptTree0=0;
#line 85 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(statement)(error_free), 143, metachop))== (PPTREE) -1 ) {
#line 85 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 85 "metachop.met"
...
#line 93 "metachop.met"
                if (NPUSH_CALL_AFF_VERIF(expTree = ,_Tak(expression), 65, metachop)){
#line 93 "metachop.met"
...
#line 105 "metachop.met"
                PPTREE _ptTree0=0;
#line 105 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(operator_function_name)(error_free), 107, metachop))== (PPTREE) -1 ) {
#line 105 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 105 "metachop.met"
...
#line 106 "metachop.met"
                PPTREE _ptTree0=0;
#line 106 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(qualified_name)(error_free), 120, metachop))== (PPTREE) -1 ) {
#line 106 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 106 "metachop.met"
...
#line 124 "metachop.met"
                PPTREE _ptTree0=0;
#line 124 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(string_list)(error_free), 145, metachop))== (PPTREE) -1 ) {
#line 124 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 124 "metachop.met"
...
#line 128 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(assignment_expression)(error_free), 19, metachop))== (PPTREE) -1 ) {
#line 128 "metachop.met"
                    MulFreeTree(7,_ptRes0,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 128 "metachop.met"
...
#line 130 "metachop.met"
                PPTREE _ptTree0=0;
#line 130 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(type_name)(error_free), 151, metachop))== (PPTREE) -1 ) {
#line 130 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 130 "metachop.met"
...
#line 134 "metachop.met"
                PPTREE _ptTree0=0;
#line 134 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(constan)(error_free), 34, metachop))== (PPTREE) -1 ) {
#line 134 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 134 "metachop.met"
...
#line 22 "metachop.met"
        PPTREE _ptTree0=0;
#line 22 "metachop.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(program)(error_free), 116, metachop))== (PPTREE) -1 ) {
#line 22 "metachop.met"
