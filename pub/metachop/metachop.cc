...
#line 13 "metachop.met"
        PPTREE _ptTree0=0;
#line 13 "metachop.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(prog)(error_free), 171, metachop))== (PPTREE) -1 ) {
#line 13 "metachop.met"
...
#line 30 "metachop.met"
                PPTREE _ptTree0=0;
#line 30 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(take_follow)(error_free), 172, metachop))== (PPTREE) -1 ) {
#line 30 "metachop.met"
...
#line 31 "metachop.met"
                PPTREE _ptTree0=0;
#line 31 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(take_follow_list)(error_free), 173, metachop))== (PPTREE) -1 ) {
#line 31 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 31 "metachop.met"
...
#line 85 "metachop.met"
                PPTREE _ptTree0=0;
#line 85 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(statement)(error_free), 145, metachop))== (PPTREE) -1 ) {
#line 85 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 85 "metachop.met"
...
#line 105 "metachop.met"
                PPTREE _ptTree0=0;
#line 105 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(operator_function_name)(error_free), 109, metachop))== (PPTREE) -1 ) {
#line 105 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 105 "metachop.met"
...
#line 106 "metachop.met"
                PPTREE _ptTree0=0;
#line 106 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(qualified_name)(error_free), 122, metachop))== (PPTREE) -1 ) {
#line 106 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 106 "metachop.met"
...
#line 124 "metachop.met"
                PPTREE _ptTree0=0;
#line 124 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(string_list)(error_free), 147, metachop))== (PPTREE) -1 ) {
#line 124 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 124 "metachop.met"
...
#line 130 "metachop.met"
                PPTREE _ptTree0=0;
#line 130 "metachop.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(type_name)(error_free), 153, metachop))== (PPTREE) -1 ) {
#line 130 "metachop.met"
                    MulFreeTree(6,_ptTree0,expTree,list,result,ret,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 130 "metachop.met"
...
#line 22 "metachop.met"
        PPTREE _ptTree0=0;
#line 22 "metachop.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(program)(error_free), 118, metachop))== (PPTREE) -1 ) {
#line 22 "metachop.met"
