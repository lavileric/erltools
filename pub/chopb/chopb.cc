...
#line 283 "chopb.met"
#line 285 "chopb.met"
    if ( (expTree=NQUICK_CALL(_Tak(conditional_expression)(error_free), 31, chopb))== (PPTREE) -1 ) {
#line 285 "chopb.met"
...
#line 287 "chopb.met"
                    if ( (_ptTree1=NQUICK_CALL(_Tak(assignment_expression)(error_free), 18, chopb))== (PPTREE) -1 ) {
#line 287 "chopb.met"
...
#line 290 "chopb.met"
#line 290 "chopb.met"
            if (NPUSH_CALL_AFF_VERIF(expFollow = ,_Tak(assignment_end), 17, chopb)){
#line 290 "chopb.met"
#line 291 "chopb.met"
#line 292 "chopb.met"
...
#line 390 "chopb.met"
#line 391 "chopb.met"
        if ( (ret=NQUICK_CALL(_Tak(type_name)(error_free), 150, chopb))== (PPTREE) -1 ) {
#line 391 "chopb.met"
            MulFreeTree(1,ret);
...
#line 393 "chopb.met"
            if ( (_ptTree1=NQUICK_CALL(_Tak(cast_expression)(error_free), 23, chopb))== (PPTREE) -1 ) {
#line 393 "chopb.met"
...
#line 269 "chopb.met"
#line 271 "chopb.met"
    if ( (expTree=NQUICK_CALL(_Tak(assignment_expression)(error_free), 18, chopb))== (PPTREE) -1 ) {
#line 271 "chopb.met"
...
#line 276 "chopb.met"
                PPTREE _ptTree0=0;
#line 276 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(assignment_expression)(error_free), 18, chopb))== (PPTREE) -1 ) {
#line 276 "chopb.met"
...
#line 257 "chopb.met"
        PPTREE _ptTree0=0;
#line 257 "chopb.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(prog)(error_free), 168, chopb))== (PPTREE) -1 ) {
#line 257 "chopb.met"
...
#line 372 "chopb.met"
#line 374 "chopb.met"
    if ( (expTree=NQUICK_CALL(_Tak(pm_expression)(error_free), 110, chopb))== (PPTREE) -1 ) {
#line 374 "chopb.met"
...
#line 377 "chopb.met"
                ReplaceTree(_ptRes0, 1, expTree );
#line 377 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(pm_expression)(error_free), 110, chopb))== (PPTREE) -1 ) {
#line 377 "chopb.met"
...
#line 331 "chopb.met"
#line 333 "chopb.met"
    if (! (NPUSH_CALL_AFF_VERIF(expTree = ,_Tak(primary_expression), 114, chopb))){
#line 333 "chopb.met"
#line 334 "chopb.met"
#line 335 "chopb.met"
        if ( (expTree=NQUICK_CALL(_Tak(simple_type_name)(error_free), 135, chopb))== (PPTREE) -1 ) {
#line 335 "chopb.met"
...
#line 347 "chopb.met"
#line 348 "chopb.met"
                    if (NPUSH_CALL_AFF_VERIF(expList = ,_Tak(expression), 64, chopb)){
#line 348 "chopb.met"
#line 349 "chopb.met"
                        {
#line 349 "chopb.met"
...
#line 362 "chopb.met"
                    ReplaceTree(_ptRes0, 1, expTree );
#line 362 "chopb.met"
                    if ( (_ptTree0=NQUICK_CALL(_Tak(primary_expression)(error_free), 114, chopb))== (PPTREE) -1 ) {
#line 362 "chopb.met"
...
#line 411 "chopb.met"
                PPTREE _ptTree0=0;
#line 411 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(take_follow)(error_free), 169, chopb))== (PPTREE) -1 ) {
#line 411 "chopb.met"
...
#line 412 "chopb.met"
                PPTREE _ptTree0=0;
#line 412 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(take_follow_list)(error_free), 170, chopb))== (PPTREE) -1 ) {
#line 412 "chopb.met"
                    MulFreeTree(6,_ptTree0,_addlist1,expTree,list,result,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 412 "chopb.met"
...
#line 448 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(expression)(error_free), 64, chopb))== (PPTREE) -1 ) {
#line 448 "chopb.met"
...
#line 449 "chopb.met"
                    PPTREE _ptTree1=0;
#line 449 "chopb.met"
                    if ( (_ptTree1=NQUICK_CALL(_Tak(statement)(error_free), 142, chopb))== (PPTREE) -1 ) {
#line 449 "chopb.met"
...
#line 452 "chopb.met"
#line 453 "chopb.met"
                if (NPUSH_CALL_AFF_VERIF(expTree = ,_Tak(expression), 64, chopb)){
#line 453 "chopb.met"
#line 454 "chopb.met"
#line 455 "chopb.met"
                    (tokenAhead == 1|| (Lex(),TRACE_LEX(1)));
...
#line 465 "chopb.met"
                PPTREE _ptTree0=0;
#line 465 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(operator_function_name)(error_free), 106, chopb))== (PPTREE) -1 ) {
#line 465 "chopb.met"
                    MulFreeTree(6,_ptTree0,_addlist1,expTree,list,result,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 465 "chopb.met"
...
#line 466 "chopb.met"
                PPTREE _ptTree0=0;
#line 466 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(qualified_name)(error_free), 119, chopb))== (PPTREE) -1 ) {
#line 466 "chopb.met"
                    MulFreeTree(6,_ptTree0,_addlist1,expTree,list,result,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 466 "chopb.met"
...
#line 484 "chopb.met"
                PPTREE _ptTree0=0;
#line 484 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(string_list)(error_free), 144, chopb))== (PPTREE) -1 ) {
#line 484 "chopb.met"
                    MulFreeTree(6,_ptTree0,_addlist1,expTree,list,result,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 484 "chopb.met"
...
#line 490 "chopb.met"
                PPTREE _ptTree0=0;
#line 490 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(type_name)(error_free), 150, chopb))== (PPTREE) -1 ) {
#line 490 "chopb.met"
                    MulFreeTree(6,_ptTree0,_addlist1,expTree,list,result,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 490 "chopb.met"
...
#line 494 "chopb.met"
                PPTREE _ptTree0=0;
#line 494 "chopb.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(constan)(error_free), 33, chopb))== (PPTREE) -1 ) {
#line 494 "chopb.met"
                    MulFreeTree(6,_ptTree0,_addlist1,expTree,list,result,statTree);
                    PROG_EXIT(primary_expression_exit,"primary_expression")
#line 494 "chopb.met"
...
#line 265 "chopb.met"
        PPTREE _ptTree0=0;
#line 265 "chopb.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(program)(error_free), 115, chopb))== (PPTREE) -1 ) {
#line 265 "chopb.met"
...
#line 299 "chopb.met"
#line 301 "chopb.met"
    if ( (expTree=NQUICK_CALL(_Tak(shift_expression)(error_free), 130, chopb))== (PPTREE) -1 ) {
#line 301 "chopb.met"
        MulFreeTree(1,expTree);
...
#line 308 "chopb.met"
                    ReplaceTree(_ptRes0, 1, expTree );
#line 308 "chopb.met"
                    if ( (_ptTree0=NQUICK_CALL(_Tak(shift_expression)(error_free), 130, chopb))== (PPTREE) -1 ) {
#line 308 "chopb.met"
                        MulFreeTree(3,_ptRes0,_ptTree0,expTree);
                        PROG_EXIT(relational_expression_exit,"relational_expression")
#line 308 "chopb.met"
