...
#line 149 "chunk.met"
#line 154 "chunk.met"
    if (! (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(quick_compound), 146, chunk))){
#line 154 "chunk.met"
#line 155 "chunk.met"
#line 156 "chunk.met"
         comment_start = 0;
...
#line 218 "chunk.met"
            while (((tokenAhead && tokenAhead != -1)|| (c != EOF)) && 
#line 218 "chunk.met"
                  (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(chunk_piece), 143, chunk))) { 
#line 218 "chunk.met"
#line 219 "chunk.met"
#line 220 "chunk.met"
                 FreeTree(retTree);_lastTree = (PTREE) 0;
...
#line 210 "chunk.met"
        PPTREE _ptTree0=0;
#line 210 "chunk.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(find_func)(error_free), 144, chunk))== (PPTREE) -1 ) {
#line 210 "chunk.met"
