...
#line 2697 "cplus.met"
#line 2699 "cplus.met"
    if ( (expTree=NQUICK_CALL(_Tak(assignment_expression)(error_free), 19, cplus))== (PPTREE) -1 ) {
#line 2699 "cplus.met"
...
#line 1139 "cplus.met"
#line 1141 "cplus.met"
    if (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(ext_all_no_linkage), 69, cplus)){
#line 1141 "cplus.met"
#line 1142 "cplus.met"
        {
#line 1142 "cplus.met"
...
#line 1144 "cplus.met"
            PPTREE _ptTree0=0;
#line 1144 "cplus.met"
            if ( (_ptTree0=NQUICK_CALL(_Tak(linkage_specification)(error_free), 91, cplus))== (PPTREE) -1 ) {
#line 1144 "cplus.met"
...
#line 1147 "cplus.met"
#line 1149 "cplus.met"
    if (! (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(protect_declare), 117, cplus))){
#line 1149 "cplus.met"
#line 1150 "cplus.met"
        if ( (retTree=NQUICK_CALL(_Tak(ext_all)(error_free), 67, cplus))== (PPTREE) -1 ) {
#line 1150 "cplus.met"
            MulFreeTree(1,retTree);
...
#line 1126 "cplus.met"
                            if ( (_ptTree1=NQUICK_CALL(_Tak(arg_declarator_type)(error_free), 12, cplus))== (PPTREE) -1 ) {
#line 1126 "cplus.met"
...
#line 1131 "cplus.met"
                if ( (_ptTree1=NQUICK_CALL(_Tak(ext_all_no_linkage)(error_free), 69, cplus))== (PPTREE) -1 ) {
#line 1131 "cplus.met"
                    MulFreeTree(6,_ptRes1,_ptTree1,_ptTree0,_addlist1,decl,listTemp);
                    PROG_EXIT(ext_all_no_linkage_exit,"ext_all_no_linkage")
#line 1131 "cplus.met"
...
#line 1131 "cplus.met"
#line 1133 "cplus.met"
    if (((((NPUSH_CALL_AFF_VERIF(decl = ,_Tak(ext_data_declaration), 74, cplus)) || 
#line 1133 "cplus.met"
          (NPUSH_CALL_AFF_VERIF(decl = ,_Tak(func_declaration), 79, cplus))) || 
#line 1133 "cplus.met"
         (NPUSH_CALL_AFF_VERIF(decl = ,_Tak(ext_decl_dir), 75, cplus))) || 
#line 1133 "cplus.met"
        (NPUSH_CALL_AFF_VERIF(decl = ,_Tak(asm_declaration), 17, cplus))) || 
#line 1133 "cplus.met"
       (NPUSH_CALL_AFF_VERIF(decl = ,_Tak(protected_array_declaration), 118, cplus))){
#line 1133 "cplus.met"
#line 1134 "cplus.met"
        {
#line 1134 "cplus.met"
...
#line 1136 "cplus.met"
            PPTREE _ptTree0=0;
#line 1136 "cplus.met"
            if ( (_ptTree0=NQUICK_CALL(_Tak(func_declaration)(error_free), 79, cplus))== (PPTREE) -1 ) {
#line 1136 "cplus.met"
                MulFreeTree(4,_ptTree0,_addlist1,decl,listTemp);
                PROG_EXIT(ext_all_no_linkage_exit,"ext_all_no_linkage")
#line 1136 "cplus.met"
...
#line 1623 "cplus.met"
#line 1625 "cplus.met"
    if (! (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(ext_data_decl_sc_ty_full), 71, cplus))){
#line 1625 "cplus.met"
#line 1626 "cplus.met"
        if ( (retTree=NQUICK_CALL(_Tak(ext_data_decl_sc_ty_short)(error_free), 72, cplus))== (PPTREE) -1 ) {
#line 1626 "cplus.met"
            MulFreeTree(1,retTree);
...
#line 1630 "cplus.met"
#line 1632 "cplus.met"
    if ((! (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(data_declaration), 43, cplus))) && 
#line 1632 "cplus.met"
       (! (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(inline_namespace), 85, cplus)))){
#line 1632 "cplus.met"
#line 1633 "cplus.met"
        if ( (retTree=NQUICK_CALL(_Tak(ext_data_decl_sc_ty)(error_free), 70, cplus))== (PPTREE) -1 ) {
#line 1633 "cplus.met"
            MulFreeTree(1,retTree);
...
#line 1654 "cplus.met"
#line 1655 "cplus.met"
            if (! (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(typedef_and_declarator), 154, cplus))){
#line 1655 "cplus.met"
#line 1656 "cplus.met"
                {
#line 1656 "cplus.met"
...
#line 1656 "cplus.met"
                    if ( (_ptTree0=NQUICK_CALL(_Tak(declarator_list)(error_free), 51, cplus))== (PPTREE) -1 ) {
#line 1656 "cplus.met"
...
#line 1660 "cplus.met"
                PPTREE _ptTree0=0;
#line 1660 "cplus.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(name_space)(error_free), 101, cplus))== (PPTREE) -1 ) {
#line 1660 "cplus.met"
                    MulFreeTree(2,_ptTree0,retTree);
                    PROG_EXIT(ext_data_declaration_exit,"ext_data_declaration")
#line 1660 "cplus.met"
...
#line 1663 "cplus.met"
                    if ( (_ptTree1=NQUICK_CALL(_Tak(ext_data_decl_simp)(error_free), 73, cplus))== (PPTREE) -1 ) {
#line 1663 "cplus.met"
...
#line 1664 "cplus.met"
                PPTREE _ptTree0=0;
#line 1664 "cplus.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(ext_data_decl_simp)(error_free), 73, cplus))== (PPTREE) -1 ) {
#line 1664 "cplus.met"
                    MulFreeTree(2,_ptTree0,retTree);
                    PROG_EXIT(ext_data_declaration_exit,"ext_data_declaration")
#line 1664 "cplus.met"
...
#line 1332 "cplus.met"
#line 1334 "cplus.met"
    if (NPUSH_CALL_AFF_VERIF(retTree = ,_Tak(directive), 55, cplus)){
#line 1334 "cplus.met"
#line 1335 "cplus.met"
        {
#line 1335 "cplus.met"
...
#line 1337 "cplus.met"
                PPTREE _ptTree0=0;
#line 1337 "cplus.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(ext_decl_if_dir)(error_free), 76, cplus))== (PPTREE) -1 ) {
#line 1337 "cplus.met"
                    MulFreeTree(2,_ptTree0,retTree);
...
#line 1338 "cplus.met"
                PPTREE _ptTree0=0;
#line 1338 "cplus.met"
                if ( (_ptTree0=NQUICK_CALL(_Tak(ext_decl_ifdef_dir)(error_free), 77, cplus))== (PPTREE) -1 ) {
#line 1338 "cplus.met"
                    MulFreeTree(2,_ptTree0,retTree);
                    PROG_EXIT(ext_decl_dir_exit,"ext_decl_dir")
#line 1338 "cplus.met"
...
#line 1274 "cplus.met"
            PPTREE _ptTree0=0;
#line 1274 "cplus.met"
            if ( (_ptTree0=NQUICK_CALL(_Tak(ext_all_ext)(error_free), 68, cplus))== (PPTREE) -1 ) {
#line 1274 "cplus.met"
...
#line 1286 "cplus.met"
                    PPTREE _ptTree1=0;
#line 1286 "cplus.met"
                    if ( (_ptTree1=NQUICK_CALL(_Tak(ext_decl_if_dir)(error_free), 76, cplus))== (PPTREE) -1 ) {
#line 1286 "cplus.met"
...
#line 1305 "cplus.met"
#line 1306 "cplus.met"
            if ( (express=NQUICK_CALL(_Tak(expression)(error_free), 65, cplus))== (PPTREE) -1 ) {
#line 1306 "cplus.met"
                MulFreeTree(6,_addlist1,_addlist2,express,list,list2,retTree);
                PROG_EXIT(ext_decl_ifdef_dir_exit,"ext_decl_ifdef_dir")
#line 1306 "cplus.met"
...
#line 3452 "cplus.met"
#line 3453 "cplus.met"
    if (NPUSH_CALL_AFF_VERIF(opt = ,_Tak(expression_for), 66, cplus)){
#line 3453 "cplus.met"
#line 3454 "cplus.met"
...
#line 3454 "cplus.met"
#line 3456 "cplus.met"
        if (NPUSH_CALL_AFF_VERIF(opt = ,_Tak(data_declaration_for), 44, cplus)){
#line 3456 "cplus.met"
#line 3457 "cplus.met"
            ReplaceTree(statTree ,1 ,opt );
#line 3457 "cplus.met"
...
#line 3460 "cplus.met"
                if ( (_ptTree1=NQUICK_CALL(_Tak(expression)(error_free), 65, cplus))== (PPTREE) -1 ) {
#line 3460 "cplus.met"
...
#line 3464 "cplus.met"
#line 3465 "cplus.met"
        if (NPUSH_CALL_AFF_VERIF(opt = ,_Tak(expression), 65, cplus)){
#line 3465 "cplus.met"
#line 3466 "cplus.met"
...
#line 3473 "cplus.met"
            PPTREE _ptTree0=0;
#line 3473 "cplus.met"
            if ( (_ptTree0=NQUICK_CALL(_Tak(statement)(error_free), 143, cplus))== (PPTREE) -1 ) {
#line 3473 "cplus.met"
...
#line 3373 "cplus.met"
#line 3377 "cplus.met"
    if (! (NPUSH_CALL_AFF_VERIF(funcTree = ,_Tak(type_and_declarator), 149, cplus))){
#line 3377 "cplus.met"
#line 3379 "cplus.met"
#line 3380 "cplus.met"
        {
...
#line 3383 "cplus.met"
        PPTREE _ptTree0=0;
#line 3383 "cplus.met"
        if ( (_ptTree0=NQUICK_CALL(_Tak(parameter_list_extended)(error_free), 110, cplus))== (PPTREE) -1 ) {
#line 3383 "cplus.met"
            MulFreeTree(7,_ptTree0,_addlist1,decList,exception,funcTree,opt,range);
            PROG_EXIT(func_declaration_exit,"func_declaration")
#line 3383 "cplus.met"
...
#line 3383 "cplus.met"
#line 3384 "cplus.met"
    if (NPUSH_CALL_AFF_VERIF(range = ,_Tak(range_modifier_function), 126, cplus)){
#line 3384 "cplus.met"
#line 3385 "cplus.met"
...
#line 3385 "cplus.met"
#line 3386 "cplus.met"
    if (NPUSH_CALL_AFF_VERIF(exception = ,_Tak(exception_list), 63, cplus)){
#line 3386 "cplus.met"
#line 3387 "cplus.met"
...
#line 3395 "cplus.met"
#line 3396 "cplus.met"
        while (NPUSH_CALL_AFF_VERIF(opt = ,_Tak(data_declaration), 43, cplus)) { 
#line 3396 "cplus.met"
#line 3397 "cplus.met"
#line 3397 "cplus.met"
...
#line 3399 "cplus.met"
            PPTREE _ptTree0=0;
#line 3399 "cplus.met"
            if ( (_ptTree0=NQUICK_CALL(_Tak(ctor_initializer)(error_free), 35, cplus))== (PPTREE) -1 ) {
#line 3399 "cplus.met"
                MulFreeTree(7,_ptTree0,_addlist1,decList,exception,funcTree,opt,range);
                PROG_EXIT(func_declaration_exit,"func_declaration")
#line 3399 "cplus.met"
...
#line 2444 "cplus.met"
                PPTREE _ptTree1=0;
#line 2444 "cplus.met"
                if ( (_ptTree1=NQUICK_CALL(_Tak(func_declarator)(error_free), 80, cplus))== (PPTREE) -1 ) {
#line 2444 "cplus.met"
