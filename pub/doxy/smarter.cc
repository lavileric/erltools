...
/// 
/// @fn PTREE   Test1 (PTREE &assign, const PTREE &refInTree = 0, FindChain &findChain, bool multiple, int level, bool searchExt = false, bool forSure = false, bool optional = true, bool addition = false, bool stopAtAddr = false) 
/// 
/// @brief	Test1 :
/// 		- perform
/// 
...
/// 
/// @fn PTREE   Test1 (PTREE &assign, const PTREE &refInTree, FindChain &findChain, bool multiple, int level, bool searchExt, bool forSure, bool optional, bool addition, bool stopAtAddr) 
/// 
//| @brief	Test1 :
//| 		- perform
/// 
...
/// 
/// @fn void    decomp (PTREE parameter1) 
/// 
/// @brief decomp
/// 
/// @param [in] parameter1 
/// 
void                decomp (PTREE parameter1) ;
