...
#   define PUT_END 0
    ...
    class clpretty {
        ...
        public :
            ...
            clpretty ()
                : currMark(0),  sizeTabTree(0),  currTabTree(0),  nbTab(0),  markTab( -1),  startComment((char *)0),  middleComment((char *)0),  endComment((char *)0)
                    ,  plusComment((char *)0),  inhibateComment(0),  maxX(0),  postInhibitor(0)
            {
            ...
            virtual void    CompleteCoordinatesInt (PTREE currTree) ;
            virtual void    CompleteCoordinatesOld (PTREE currTree) ;
