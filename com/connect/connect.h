...
class Connection : public MetaConnection {
    ...
    public :
        ...
        Connection ()
            : pvName(""),  pvChannel(""),  pvSendEvent(0),  pvSendEventChunk(0),  pvSendEventChunkEnd(0),  pvGetEvent(0),  pvGetEventBlocked(0)
                ,  pvWaitingResponse(false),  pvIsOpened(false)
        {}
        ...
        virtual PTREE   ReceiveContent (bool blocked = false) ;
        ...
        {
            pvInetUtil.Syntax(channel, fileSyntax);
            return *this ;
        }
        ...
        virtual DecompAsn *Decomp ( const EString &channel )
        {
        ...
        virtual PTREE FullInterpret ( char *message, EString channel = " " )
        {
        ...
        {
            Coding  *coding = pvInetUtil.FullEncode(tree, channel);
            EString resString = *((EString *)(*coding));
    ...
    private :
        ...
        //  pdu waiting
        InetUtil    pvInetUtil ;                 // for writing and reading
