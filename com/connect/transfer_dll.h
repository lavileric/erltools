#ifndef transfer_dll_definition
#define transfer_dll_definition 1
#include "tabsort.h"
...
#endif
EXTERN_FUNC_VOID transferSetParam ( char * metaName,
TabSortString ** pptStackString    ,
TabSortEqual<TREE> ** pptStackPtree  ,
bool * pptStackInitialized  ,  void (*ptMetaExit) ( int, const char *));  EXTERN_FUNC_PTREE transferRootDecode(EString & ruleName, EString & val  , CoordString & coord, bool checkTag) ;
EXTERN_FUNC_VOID  transferRootEncode(EString & ruleName , EString & resString  , PTREE val) ;
#endif
